...
class BaseNpc(arcade.Sprite):
    def __init__(self, scene, sprite_path=":resources:/images/animated_characters/male_person/malePerson_idle.png", position=(128, 128), scale=1, name="NPC", title="Title"):
        super().__init__(
            sprite_path,
            scale=scale
        )
